...
// ! easier way to do this function.
...
console.log('Exercise 4 Result:', generateEmail("johndoe", "theman.com"));
...
return `Good evening, ${name}!`
        ...
        return `what time is that, ${name}`
    }

}

console.log('Exercise 5 Result:', greetUser("tom", "morning"));
...
console.log('Exercise 7 Result:', checkPalindrome("oco"));
...
function maxOfThree(num1, num2, num3) {
    ...
    // other ways to do this is just reurn Math.max(a,b,c)


console.log('Exercise 8 Result:', maxOfThree(18, 10, 8));
...
console.log('Exercise 9 Result:', calculateTip(250, 20));
...
Complete the exercise in the space below:
*/
function basicCalculator(num1, num2, task) {
    if (task === "add"){
        return num1 + num2
